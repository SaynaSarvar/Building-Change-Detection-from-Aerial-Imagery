...
This project requires `best_model.pth` from the [Building Footprint Extraction](https://github.com/SaynaSarvar/building-footprint-segformer) project. Place it in your Google Drive root.
